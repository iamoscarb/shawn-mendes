        ...
        <Card className="flex lg:flex-row md:flex-row sm:flex-col max-sm:flex-col"
            ...
            <Box className="flex flex-col w-full pt-2 md:pl-2 md:pt-0">
                <CardContent sx={{ flex: '1 0 auto' }}>
                    <h1 className="text-center text-2xl font-medium md:text-left text-(--mui-palette-primary-dark)/50 bt-0 font-lato">{albumName}</h1>
                    <h2 className="text-center text-(--mui-palette-text-primary-dark) mb-1 md:text-left font-lato">{albumSinger}</h2>
                                ...
                                <div className="group flex items-center justify-between p-2 rounded-md hover:bg-gray-400/20 transition-colors select-none cursor-pointer" key={song.track}
                                    ...
                                    <div className="flex items-center gap-4">
                                        ...
                                        <div className="flex flex-col text-left">
                                            ...
                                            <p className="italic text-[13px] text-gray-700 group-hover:text-(--mui-palette-text-primary)">{song.singer}</p>
                                        </div>
                                    </div>
